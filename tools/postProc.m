...
flNm = ['..' flSep 'test' flSep 'OC4_T30p00_fixed_stiff.txt' flSep 'output.txt'];xlim([0 200])

flNm_old = '/home/lucas/Google Drive_31-12-17/Doutorado/Software Morison/MATLAB version/OC4_waveOnly_H1000/45deg/firstPlatform_45deg_T30p00_out.mat';
