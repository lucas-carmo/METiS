...
//		
		...
		OUTFLAG_HD_FORCE_DRAG_1ST,
		OUTFLAG_HD_FORCE_1_1ST,
//		
		OUTFLAG_HD_FORCE_DRAG_EXT,
		OUTFLAG_HD_FORCE_1_EXT,
		OUTFLAG_HD_FORCE_2_EXT,
		OUTFLAG_HD_FORCE_3_EXT,
		OUTFLAG_HD_FORCE_REM_EXT,
		OUTFLAG_HD_FORCE_DRAG_EXT_1ST,
		OUTFLAG_HD_FORCE_1_EXT_1ST,
//
		OUTFLAG_HD_ADD_MASS_FORCE,
//
		OUTFLAG_HD_FORCE,
		OUTFLAG_HD_FORCE_1ST,
//
		OUTFLAG_HS_FORCE,
		OUTFLAG_HS_FORCE_1ST,
//
		OUTFLAG_MOOR_FORCE,
		OUTFLAG_MOOR_FORCE_1ST,
//
