	...
	for (int ii = 1; ii <= ncyl; ++ii)
	{
		...
		******/
		...
		if (hydroMode == 2)
		{
			...
			moment_inertia_2nd_part4_ii = cross(R_ii * zvec_sd, force_inertia_2nd_part4_ii);
			moment_inertia_2nd_part5_ii = cross(R_ii * zvec_sd, force_inertia_2nd_part5_ii);
		}
