...
public:
	...
	*****************************************************/
	...
	vec::fixed<6> hydrodynamicForce(const ENVIR &envir, const int hydroMode);
	vec::fixed<6> hydrostaticForce(const ENVIR &envir, const int hydroMode);
	vec::fixed<6> aeroForce(const ENVIR &envir);
	vec::fixed<6> mooringForce(const int hydroMode);
