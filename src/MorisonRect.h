...
public:
	...
	*****************************************************/
	...
	virtual mat::fixed<6, 6> addedMass_perp(const double rho, const vec::fixed<3> &refPt) const override;
	...
	virtual mat::fixed<6, 6> addedMass_paral(const double rho, const vec::fixed<3> &refPt) const override;
