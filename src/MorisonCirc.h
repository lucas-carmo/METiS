...
public:
	...
	*****************************************************/
	...
	virtual vec::fixed<6> hydroForce_relWaveElev_inertia(const ENVIR &envir, const vec::fixed<3> &refPt) const override;
	virtual vec::fixed<6> hydroForce_relWaveElev_drag(const ENVIR& envir, const vec::fixed<3>& refPt) const override;
