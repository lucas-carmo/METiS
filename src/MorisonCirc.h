...
public:
	...
	*****************************************************/
	...
	vec::fixed<6> hydrostaticForce_helper(const double rho, const double g, const vec::fixed<3> &n1, const vec::fixed<3> &n2_in, const vec::fixed<3> &xvec, const vec::fixed<3> &yvec, const vec::fixed<3> &zvec) const;
